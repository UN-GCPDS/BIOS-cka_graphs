...
from sklearn.metrics import mean_squared_error, mean_absolute_error, make_scorer, pairwise_distances
from sklearn.manifold import TSNE
from sklearn.decomposition import PCA
from sklearn.kernel_ridge import KernelRidge
from sklearn.model_selection import train_test_split, LeaveOneOut, GridSearchCV, cross_val_score, cross_val_predict, ShuffleSplit, StratifiedShuffleSplit, StratifiedKFold, KFold
from sklearn.linear_model import ElasticNet
from scipy.stats import mode, linregress, spearmanr, pearsonr
...
dataWPLI = loadmat('../giga_wpli_data/Bios_datos/Grafos_rest_giga.mat')
acc = load(open(
    "../giga_wpli_data/Bios_datos/Results_biclass_FBCSP_2tau_elastic_LDA_giga_acc.joblib", "rb"))
...
for i in range(16 - 1):
    ...
    with open(os.path.join(ouput_dir, f'clus_saveridgetrain{str(X_c.shape[1])}.p'), 'wb') as f:
...
for i in range(16 - 1):
    ...
    pickle.dump(results, open(os.path.join(
        ouput_dir, f"clus_saveElasticNe{str(X_c.shape[1])}.p"), "wb"))
